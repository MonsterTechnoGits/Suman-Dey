...
function DockItem({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className={`hover:cursor-pointer relative inline-flex items-center justify-center rounded-full bg-[#060606] border-neutral-700 border-2 shadow-md ${className}`}
      tabIndex={0}
      role='button'
      aria-haspopup='true'
    >
